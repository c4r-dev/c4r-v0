...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      ...
      <head>
        <title>C4R Units - Development and Testing</title>
        <meta name="description" content="C4R Units - Development and Testing" />
      ...
      <body>
        <header className="header"> {/* Header class from globals.css */}
          ...
          <div className="title-container"> {/* Title container class */}
            <h1 className="title">C4R Units - Development and Testing</h1> {/* Title class */}
          </div>
        </header>
